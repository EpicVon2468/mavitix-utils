 ...
 *
 * From Linux Standard Base 5.0 Core (Generic); Chapter 14.3.22: "GNU
 * Extensions for libc":
 *
 * """
 * An LSB conforming implementation shall provide the generic functions
 * for GNU Extensions for libc specified in Table 14-37, with the full
 * mandatory functionality as described in the referenced underlying
 * specification.
 * """
 *
 * From the function specifications in Linux Standard Base 5.0 Core
 * (Generic):
 *
 * """
